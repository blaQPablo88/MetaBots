void OnTick() 
   {
     ...
     if (OrdersTotal()<100) {
        if ((currentPrice > movingAverage) && (currentPrice > lastPrice)) {
           ...
           OrderSend ("EURUSDm",OP_BUY,0.01,EURUSDmAsk,3,EURUSDmAsk-300*Point,EURUSDmAsk+70*Point,NULL,0,0,Green);
           OrderSend ("GBPUSDm",OP_BUY,0.01,GBPUSDmAsk,3,GBPUSDmAsk-300*Point,GBPUSDmAsk+70*Point,NULL,0,0,Green);
           OrderSend ("NZDUSDm",OP_BUY,0.01,NZDUSDmAsk,3,NZDUSDmAsk-300*Point,NZDUSDmAsk+70*Point,NULL,0,0,Green);
           OrderSend ("AUDUSDm",OP_BUY,0.01,AUDUSDmAsk,3,AUDUSDmAsk-300*Point,AUDUSDmAsk+70*Point,NULL,0,0,Green);
           OrderSend ("DXY",OP_BUY,0.01,DXYmAsk,3,DXYmAsk-300*Point,DXYmAsk+70*Point,NULL,0,0,Green);
     ...
     if (OrdersTotal()<100) {
        if ((currentPrice < movingAverage) && (currentPrice < lastPrice)) {                                                              
           ...
           OrderSend ("EURUSDm",OP_SELL,0.01,EURUSDmBid,3,EURUSDmBid+300*Point,EURUSDmBid-90*Point,NULL,0,0,Red);
           OrderSend ("GBPUSDm",OP_SELL,0.01,GBPUSDmBid,3,GBPUSDmBid+300*Point,GBPUSDmBid-90*Point,NULL,0,0,Red);
           OrderSend ("NZDUSDm",OP_SELL,0.01,NZDUSDmBid,3,NZDUSDmBid+300*Point,NZDUSDmBid-90*Point,NULL,0,0,Red);
           OrderSend ("AUDUSDm",OP_SELL,0.01,AUDUSDmBid,3,AUDUSDmBid+300*Point,AUDUSDmBid-90*Point,NULL,0,0,Red);
           OrderSend ("DXYm",OP_SELL,0.01,DXYmBid,3,DXYmBid+300*Point,DXYmBid-90*Point,NULL,0,0,Red);     
        }    
     }                                               
